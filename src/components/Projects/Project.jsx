          ...
          <div className="card-project">
            ...
            <div className="project-card-content">
              ...
              <p className="project-card-description">
                ...
                credibilidade e autoridade no mercado, alem de uma identidade
                unica e marcante. Apos um alinhamento detalhado com o
                proprietário e uma pesquisa meticulosa de mercado, em sua area
          ...
          <div className="card-project">
            ...
            <div className="project-card-content">
              ...
              <p className="project-card-description">
                ...
                relevancia nos motores de busca, impulsionando assim sua
                credibilidade.
              </p>
              <div className="project-card-button">
                <a
          ...
          <div className="card-project">
            ...
            <div className="project-card-content">
              ...
              <p className="project-card-description">
                ...
                e meticulosa em suas redes sociais, conseguimos avaliar a melhor
